    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between animate-fade-in">
                <div>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">Enhanced Command Center</h1>
                    <p className="text-sm text-muted-foreground mt-1 text-primary/80">Safe Implementation - Unified Fleet Intelligence</p>
                </div>
