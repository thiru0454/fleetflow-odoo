              ...
              {filteredTrips.length > 0 ? (
                filteredTrips.map((t, i) => {
                  ...
                  return (
                    ...
                    >
                      <td className="align-left font-mono font-medium text-primary group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-primary group-hover:to-primary/70 transition-all">{t.id}</td>
                      ...
                      <td className="align-left font-medium group-hover:text-primary transition-colors">{driver?.name || '—'}</td>
                      <td className="align-left text-sm text-muted-foreground group-hover:text-muted-foreground/90 transition-colors">
                        <div className="truncate">{t.origin} → {t.destination}</div>
                      </td>
                      <td className="align-right font-medium group-hover:text-primary transition-colors">{t.cargoWeight}kg</td>
